...
The end-to-end tests assert that each v1 Adapter connects, authenticates, and applies its Default Database / logical namespace behavior against a real service.
